...
const routes: Routes = [
  ...
  {
    path: 'img-zoom',
    loadChildren: () => import('./pages/img-zoom/img-zoom.module').then( m => m.ImgZoomPageModule)
  },
  {
    path: 'img-zoom2',
    loadChildren: () => import('./pages/img-zoom2/img-zoom2.module').then( m => m.ImgZoom2PageModule)
  },   {
    path: 'slides',
